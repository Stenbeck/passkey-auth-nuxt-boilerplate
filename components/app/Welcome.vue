<template>
	<div class="py-24 px-4 sm:px-6 lg:px-8 mx-auto max-w-2xl">
		...
		<p class="mt-2 text-sm text-gray-700">
			Welcome {{ user?.firstName }}, you are now logged in. This is an example of a logged in page. If you want to add a
			new passkey or manage your existing, simply go to the
